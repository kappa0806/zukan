...
const CREATURES = {
  animals: [
    ...
    { img: 'images/crocodile.jpg', name: 'わに', nameEn: 'Crocodile', counter: 'ひき', desc: 'おおきな くちに するどい はが いっぱい！かわや みずうみに すんでいるよ。きょうりゅうの じだいから いるんだ。', descEn: 'A huge mouth full of sharp teeth! Lives in rivers and lakes. They\'ve been around since the dinosaur age!', trivia: '1000キロの ちからで かむよ！どうぶつの なかで いちばん かむ ちからが つよいんだ。', triviaEn: 'They bite with a force of 1000 kg! The strongest bite of any animal.' },
    { img: 'images/red_panda.jpg', name: 'れっさーぱんだ', nameEn: 'Red Panda', counter: 'とう', desc: 'あかちゃいろの ふわふわの け！きの うえで くらすよ。ささの はっぱが だいすき。', descEn: 'Fluffy reddish-brown fur! Lives in trees and loves bamboo leaves.', trivia: 'ジャイアントパンダより さきに「パンダ」と なまえが ついたんだよ！もとの パンダは こっち。', triviaEn: 'Red pandas were called "panda" before giant pandas! They\'re the original panda.' },
    { img: 'images/river_otter.jpg', name: 'かわうそ', nameEn: 'Otter', counter: 'ひき', desc: 'かわで さかなを つかまえるよ。すいすい およいで、いしの うえで あそぶ すがたが かわいい！', descEn: 'Catches fish in rivers. So cute swimming around and playing on rocks!', trivia: 'みずの なかで めを あけたまま およげるんだよ！とくべつな まぶたが あるんだ。', triviaEn: 'They can swim with their eyes open underwater! They have a special eyelid for it.' },
    { img: 'images/hedgehog.jpg', name: 'はりねずみ', nameEn: 'Hedgehog', counter: 'ひき', desc: 'せなかに たくさんの はりが あるよ。まるくなって じぶんを まもるんだ。よるに かつどう するよ。', descEn: 'Lots of spines on their back! Curls into a ball for protection. Active at night.', trivia: 'はりの かずは やく 5000ぼん！1ぽんずつ うごかせるんだよ。', triviaEn: 'They have about 5000 spines! And they can move each one individually.' },
    { img: 'images/bat.jpg', name: 'こうもり', nameEn: 'Bat', counter: 'ひき', desc: 'そらを とべる ゆいいつの ほにゅうるい！よるに とんで、ちょうおんぱで まわりを しるんだよ。', descEn: 'The only mammal that can fly! Active at night, using echolocation to see.', trivia: 'さかさまに ぶらさがって ねむるのは、すぐに とびたてる ようにする ためなんだよ！', triviaEn: 'They sleep upside down so they can take off quickly when needed!' },
    { img: 'images/skunk.jpg', name: 'すかんく', nameEn: 'Skunk', counter: 'ひき', desc: 'しろと くろの しましまもよう。おしりから くさい ガスを だして みを まもるよ！', descEn: 'Black and white stripes. Sprays stinky gas from its bottom for protection!', trivia: 'くさい ガスは 5メートルも とばせるよ！あまりの くささに くまも にげちゃう。', triviaEn: 'They can spray their stinky gas 5 meters far! Even bears run away from the smell.' },
    { img: 'images/alpaca.jpg', name: 'あるぱか', nameEn: 'Alpaca', counter: 'とう', desc: 'もこもこの けが ふわふわ！みなみアメリカの やまに すんでいるよ。おとなしい せいかく。', descEn: 'Super fluffy wool! Lives in the mountains of South America. Very gentle.', trivia: 'おこると つばを はくんだよ！でも ふだんは とっても やさしい どうぶつ。', triviaEn: 'They spit when angry! But normally they\'re very gentle animals.' },
    { img: 'images/chameleon.jpg', name: 'かめれおん', nameEn: 'Chameleon', counter: 'ひき', desc: 'からだの いろが かわる ふしぎな トカゲ！ながい したで むしを つかまえるよ。めが べつべつに うごくんだ。', descEn: 'A mysterious lizard that changes color! Catches bugs with a long tongue. Each eye moves independently!', trivia: 'したの ながさは からだと おなじくらい！0.07びょうで むしを つかまえるよ。', triviaEn: 'Their tongue is as long as their body! They catch bugs in just 0.07 seconds.' },
    { img: 'images/araiguma.jpg', name: 'あらいぐま', nameEn: 'Raccoon', counter: 'ひき', desc: 'たべものを あらう しぐさが なまえの ゆらい！しましまの しっぽと くろい マスクが とくちょう。', descEn: 'Named for looking like they wash their food! Famous for striped tail and black mask.', trivia: 'てさきが とっても きようで、ドアの ノブも あけられるんだよ！', triviaEn: 'Their fingers are super nimble - they can even open door knobs!' },
    { img: 'images/mole.jpg', name: 'もぐら', nameEn: 'Mole', counter: 'ひき', desc: 'つちの なかに トンネルを ほって くらすよ。おおきな てで じめんを ほるのが とくい！', descEn: 'Lives in tunnels underground. Great at digging with big hands!', trivia: '1にちに じぶんの たいじゅうと おなじくらいの たべものを たべるよ！おなかが すくと たいへん。', triviaEn: 'They eat about their own body weight in food every day! They get in trouble if they go hungry.' },
    { img: 'images/weasel.jpg', name: 'いたち', nameEn: 'Weasel', counter: 'ひき', desc: 'ほそながい からだで すばしっこい！ちいさいけど ゆうかんな ハンターだよ。', descEn: 'Long slim body and super quick! Small but a brave hunter.', trivia: 'からだが ほそいから、ネズミの あなにも はいれるんだよ！すごく ちいさく なれる。', triviaEn: 'Their slim body lets them fit into mouse holes! They can squeeze into tiny spaces.' },
    { img: 'images/crane_bird.jpg', name: 'つる', nameEn: 'Crane', counter: 'わ', desc: 'おおきくて うつくしい とり。あたまの あかい もようが とくちょう。ながいき の シンボル！', descEn: 'A big beautiful bird with a red mark on its head. A symbol of long life!', trivia: '1ぽんあしで たつのは からだの ねつを にがさない ためなんだよ！', triviaEn: 'They stand on one leg to keep their body heat from escaping!' },
    { img: 'images/eagle.jpg', name: 'わし', nameEn: 'Eagle', counter: 'わ', desc: 'おおきな つばさで そらの おうさま！するどい めで とおくの えものを みつけるよ。', descEn: 'King of the sky with huge wings! Sharp eyes spot prey from far away.', trivia: 'しりょくは にんげんの 8ばい！2キロ さきの ウサギも みつけられるんだよ。', triviaEn: 'Their eyesight is 8 times better than humans! They can spot a rabbit 2 km away.' },
    { img: 'images/kingfisher.jpg', name: 'かわせみ', nameEn: 'Kingfisher', counter: 'わ', desc: 'あおと オレンジの きれいな とり。みずに ダイブして さかなを つかまえるのが とくい！', descEn: 'A beautiful blue and orange bird. Expert at diving into water to catch fish!', trivia: 'しんかんせんの はなの かたちは、かわせみの くちばしを まねして つくったんだよ！', triviaEn: 'The shape of the bullet train\'s nose was inspired by the kingfisher\'s beak!' },
    { img: 'images/cockatoo.jpg', name: 'おうむ', nameEn: 'Cockatoo', counter: 'わ', desc: 'おおきな とさかが じまん！ことばを おぼえるのが とくいで、ダンスも するんだよ。', descEn: 'Proud of their big crest! Great at learning words and even dancing.', trivia: '80ねん いじょう いきる おうむも いるんだよ！にんげんと おなじくらい ながいき。', triviaEn: 'Some cockatoos live over 80 years! Almost as long as humans.' },
  ],
  bugs: [
...
const VARIETIES_RAW = {
  ...
  'わに': [
    { img: 'images/varieties/nile_crocodile.jpg', name: 'ナイルワニ', nameEn: 'Nile Crocodile', desc: 'アフリカで いちばん おおきい ワニ。かわで まちぶせ するのが とくい！', descEn: 'Africa\'s biggest crocodile. Expert at ambushing prey in rivers!' },
    { img: 'images/varieties/alligator.jpg', name: 'アメリカアリゲーター', nameEn: 'American Alligator', desc: 'はなが まるい のが とくちょう。アメリカの ぬまちに すんでいるよ。', descEn: 'Known for their rounded snout. Lives in American swamps.' },
    { img: 'images/varieties/gharial.jpg', name: 'インドガビアル', nameEn: 'Gharial', desc: 'ほそながい くちが とくちょう。さかなを たべる のが せんもん！', descEn: 'Famous for their long thin snout. Specialists at catching fish!' },
  ],
  'れっさーぱんだ': [
    { img: 'images/varieties/styan_red_panda.jpg', name: 'シセンレッサーパンダ', nameEn: 'Styan\'s Red Panda', desc: 'ちゅうごくの しせんしょうに すむよ。おおきめで いろが こいんだ。', descEn: 'Lives in Sichuan, China. Bigger with darker fur.' },
    { img: 'images/varieties/nepal_red_panda.jpg', name: 'ネパールレッサーパンダ', nameEn: 'Himalayan Red Panda', desc: 'ヒマラヤの やまに すむよ。かおが すこし しろいのが とくちょう。', descEn: 'Lives in the Himalayas. Face is a bit whiter.' },
  ],
  'かわうそ': [
    { img: 'images/varieties/asian_small_clawed_otter.jpg', name: 'コツメカワウソ', nameEn: 'Asian Small-clawed Otter', desc: 'せかいで いちばん ちいさい カワウソ。てが ちいさくて かわいい！', descEn: 'The world\'s smallest otter. Tiny paws are so cute!' },
    { img: 'images/varieties/eurasian_otter.jpg', name: 'ユーラシアカワウソ', nameEn: 'Eurasian Otter', desc: 'ヨーロッパや アジアの かわに すむよ。およぎが とくい！', descEn: 'Lives in rivers across Europe and Asia. Great swimmer!' },
    { img: 'images/varieties/north_american_otter.jpg', name: 'カナダカワウソ', nameEn: 'North American Otter', desc: 'きたアメリカの かわに すむ げんきな カワウソ。あそぶのが だいすき！', descEn: 'A playful otter in North American rivers. Loves to play!' },
  ],
  'はりねずみ': [
    { img: 'images/varieties/four_toed_hedgehog.jpg', name: 'ヨツユビハリネズミ', nameEn: 'Four-toed Hedgehog', desc: 'ペットとして にんきの ハリネズミ。うしろあしの ゆびが 4ほん！', descEn: 'Popular as pets! Has 4 toes on their back feet.' },
    { img: 'images/varieties/european_hedgehog.jpg', name: 'ナミハリネズミ', nameEn: 'European Hedgehog', desc: 'ヨーロッパの にわで よく みるよ。まるくなるのが とくい！', descEn: 'Often seen in European gardens. Expert at curling into a ball!' },
    { img: 'images/varieties/long_eared_hedgehog.jpg', name: 'オオミミハリネズミ', nameEn: 'Long-eared Hedgehog', desc: 'おおきな みみが とくちょう。さばくにも すめる つよい ハリネズミ。', descEn: 'Famous for big ears. Tough enough to live in deserts!' },
  ],
  'こうもり': [
    { img: 'images/varieties/fruit_bat.jpg', name: 'オオコウモリ', nameEn: 'Fruit Bat', desc: 'つばさを ひろげると 1メートル いじょう！くだものが だいすき。', descEn: 'Wingspan over 1 meter! Loves fruit.' },
    { img: 'images/varieties/pipistrelle.jpg', name: 'アブラコウモリ', nameEn: 'Pipistrelle', desc: 'にほんで よく みる ちいさな コウモリ。まちの なかにも いるよ。', descEn: 'A small bat commonly seen in Japan. Lives even in cities!' },
    { img: 'images/varieties/horseshoe_bat.jpg', name: 'キクガシラコウモリ', nameEn: 'Horseshoe Bat', desc: 'はなの かたちが ばてい みたい！どうくつに すんでいるよ。', descEn: 'Nose shaped like a horseshoe! Lives in caves.' },
  ],
  'すかんく': [
    { img: 'images/varieties/striped_skunk.jpg', name: 'シマスカンク', nameEn: 'Striped Skunk', desc: 'しろい しまが せなかに 2ほん。いちばん ゆうめいな スカンク！', descEn: 'Two white stripes on the back. The most famous skunk!' },
    { img: 'images/varieties/spotted_skunk.jpg', name: 'マダラスカンク', nameEn: 'Spotted Skunk', desc: 'しましまじゃ なくて まだらもよう。さかだちして いかくするよ！', descEn: 'Spotted pattern instead of stripes. Does handstands to threaten!' },
    { img: 'images/varieties/hog_nosed_skunk.jpg', name: 'ブタバナスカンク', nameEn: 'Hog-nosed Skunk', desc: 'ぶたみたいな はなが とくちょう。つちを ほって むしを さがすよ。', descEn: 'Pig-like nose is their trademark. Digs in soil to find bugs.' },
  ],
  'あるぱか': [
    { img: 'images/varieties/huacaya.jpg', name: 'ワカイヤ', nameEn: 'Huacaya', desc: 'もこもこ ふわふわの けが にんき！テディベアみたい。', descEn: 'Fluffy puffy wool is so popular! Looks like a teddy bear.' },
    { img: 'images/varieties/suri_alpaca.jpg', name: 'スリ', nameEn: 'Suri', desc: 'ながい けが カーテンみたいに さがるよ。おしゃれな アルパカ！', descEn: 'Long wool hangs down like curtains. A stylish alpaca!' },
    { img: 'images/varieties/llama.jpg', name: 'リャマ', nameEn: 'Llama', desc: 'アルパカの おおきい しんせき。にもつを はこぶ おてつだいを するよ。', descEn: 'Alpaca\'s bigger relative. Helps carry loads in the mountains.' },
  ],
  'かめれおん': [
    { img: 'images/varieties/panther_chameleon.jpg', name: 'パンサーカメレオン', nameEn: 'Panther Chameleon', desc: 'カラフルで いちばん きれい！マダガスカルに すんでいるよ。', descEn: 'The most colorful chameleon! Lives in Madagascar.' },
    { img: 'images/varieties/veiled_chameleon.jpg', name: 'エボシカメレオン', nameEn: 'Veiled Chameleon', desc: 'あたまに おおきな かぶとみたいな トサカが あるよ。', descEn: 'Has a big helmet-like crest on its head!' },
    { img: 'images/varieties/jackson_chameleon.jpg', name: 'ジャクソンカメレオン', nameEn: 'Jackson\'s Chameleon', desc: '3ぼんの つのが ある！きょうりゅうみたいで かっこいい。', descEn: 'Has 3 horns! Looks cool like a dinosaur.' },
  ],
  'あらいぐま': [
    { img: 'images/varieties/common_raccoon.jpg', name: 'アライグマ', nameEn: 'Common Raccoon', desc: 'きたアメリカの もりに すむよ。てさきが きようで なんでも つかめる！', descEn: 'Lives in North American forests. Nimble fingers can grab anything!' },
    { img: 'images/varieties/crab_eating_raccoon.jpg', name: 'カニクイアライグマ', nameEn: 'Crab-eating Raccoon', desc: 'みなみアメリカに すむよ。かにや えびを つかまえて たべるんだ。', descEn: 'Lives in South America. Catches and eats crabs and shrimp.' },
    { img: 'images/varieties/coati.jpg', name: 'ハナグマ', nameEn: 'Coati', desc: 'ながい はなが とくちょう！アライグマの なかまだよ。しっぽが ピンと たっているね。', descEn: 'Famous for their long nose! A relative of raccoons with an upright tail.' },
  ],
  'もぐら': [
    { img: 'images/varieties/azuma_mole.jpg', name: 'アズマモグラ', nameEn: 'Japanese Mole', desc: 'にほんの ひがしがわに すむ モグラ。にわの したに トンネルを ほるよ。', descEn: 'Lives in eastern Japan. Digs tunnels under gardens.' },
    { img: 'images/varieties/european_mole.jpg', name: 'ヨーロッパモグラ', nameEn: 'European Mole', desc: 'ヨーロッパの のはらに すむよ。モグラづかを つくるのが とくい！', descEn: 'Lives in European fields. Expert at making molehills!' },
    { img: 'images/varieties/star_nosed_mole.jpg', name: 'ホシバナモグラ', nameEn: 'Star-nosed Mole', desc: 'はなの さきに ほしの かたちの ヒダが ある！せかいで いちばん はやく たべる どうぶつ。', descEn: 'Has star-shaped tentacles on its nose! The fastest-eating animal in the world.' },
  ],
  'いたち': [
    { img: 'images/varieties/ferret.jpg', name: 'フェレット', nameEn: 'Ferret', desc: 'ペットとして にんき！ひとなつっこくて あそぶのが だいすき。', descEn: 'Popular as pets! Friendly and loves to play.' },
    { img: 'images/varieties/ermine.jpg', name: 'オコジョ', nameEn: 'Ermine', desc: 'ふゆは まっしろに なるよ。ちいさくて とっても すばしっこい！', descEn: 'Turns all white in winter. Small and incredibly quick!' },
    { img: 'images/varieties/japanese_weasel.jpg', name: 'ニホンイタチ', nameEn: 'Japanese Weasel', desc: 'にほんに すむ イタチ。かわの ちかくで さかなや カエルを たべるよ。', descEn: 'Lives in Japan near rivers, eating fish and frogs.' },
  ],
  'つる': [
    { img: 'images/varieties/red_crowned_crane.jpg', name: 'タンチョウ', nameEn: 'Red-crowned Crane', desc: 'あたまの あかが うつくしい！にほんの ほっかいどうにも いるよ。', descEn: 'Beautiful red crown! Also found in Hokkaido, Japan.' },
    { img: 'images/varieties/hooded_crane.jpg', name: 'ナベヅル', nameEn: 'Hooded Crane', desc: 'くろい からだに しろい くび。にほんの かごしまに ふゆ やってくるよ。', descEn: 'Black body with white neck. Visits Kagoshima, Japan in winter.' },
    { img: 'images/varieties/demoiselle_crane.jpg', name: 'アネハヅル', nameEn: 'Demoiselle Crane', desc: 'いちばん ちいさい ツル。ヒマラヤさんみゃくを こえて わたるよ！', descEn: 'The smallest crane. Migrates over the Himalayas!' },
  ],
  'わし': [
    { img: 'images/varieties/golden_eagle.jpg', name: 'イヌワシ', nameEn: 'Golden Eagle', desc: 'やまの おうさま！きんいろの あたまが かっこいい。', descEn: 'King of the mountains! Cool golden head.' },
    { img: 'images/varieties/bald_eagle.jpg', name: 'ハクトウワシ', nameEn: 'Bald Eagle', desc: 'アメリカの シンボル。しろい あたまが とくちょう！', descEn: 'Symbol of America. Famous for their white head!' },
    { img: 'images/varieties/stellers_sea_eagle.jpg', name: 'オオワシ', nameEn: 'Steller\'s Sea Eagle', desc: 'せかいで いちばん おもい ワシ。にほんの ほっかいどうにも くるよ。', descEn: 'The heaviest eagle in the world. Visits Hokkaido, Japan.' },
  ],
  'かわせみ': [
    { img: 'images/varieties/common_kingfisher.jpg', name: 'カワセミ', nameEn: 'Common Kingfisher', desc: 'あおい からだが ほうせきみたい！かわの そばで さかなを まつよ。', descEn: 'Blue body like a jewel! Waits by the river for fish.' },
    { img: 'images/varieties/crested_kingfisher.jpg', name: 'ヤマセミ', nameEn: 'Crested Kingfisher', desc: 'おおきな カワセミ。あたまの けが ボサボサで かわいい！', descEn: 'A big kingfisher with adorably messy head feathers!' },
    { img: 'images/varieties/ruddy_kingfisher.jpg', name: 'アカショウビン', nameEn: 'Ruddy Kingfisher', desc: 'あかい くちばしと からだが きれい。もりの なかに すむよ。', descEn: 'Beautiful red beak and body. Lives deep in forests.' },
  ],
  'おうむ': [
    { img: 'images/varieties/sulphur_crested_cockatoo.jpg', name: 'キバタン', nameEn: 'Sulphur-crested Cockatoo', desc: 'きいろい トサカが じまん！おおきな こえで なくよ。', descEn: 'Proud of their yellow crest! Has a very loud voice.' },
    { img: 'images/varieties/galah.jpg', name: 'モモイロインコ', nameEn: 'Galah', desc: 'ピンクと グレーの おしゃれな おうむ。オーストラリアに いるよ。', descEn: 'A stylish pink and grey cockatoo from Australia.' },
    { img: 'images/varieties/major_mitchell_cockatoo.jpg', name: 'クルマサカオウム', nameEn: 'Major Mitchell\'s Cockatoo', desc: 'しろと ピンクの きれいな おうむ。せかいで いちばん うつくしい おうむ！', descEn: 'Beautiful white and pink. Said to be the most beautiful cockatoo!' },
  ],
};
...
const HABITATS = {
  ...
  'わに': { regions: ['africa', 'asia', 'oceania', 'south_america', 'north_america'], ja: 'あたたかい ちいきの かわや みずうみ', en: 'Rivers & lakes in warm regions' },
  'れっさーぱんだ': { regions: ['asia'], ja: 'ちゅうごく・ネパールの やま', en: 'Mountains of China & Nepal' },
  'かわうそ': { regions: ['asia', 'europe', 'north_america', 'south_america', 'africa'], ja: 'せかいの かわや みずうみ', en: 'Rivers & lakes worldwide' },
  'はりねずみ': { regions: ['europe', 'asia', 'africa'], ja: 'ヨーロッパ・アジア・アフリカ', en: 'Europe, Asia & Africa' },
  'こうもり': { regions: ['worldwide'], ja: 'なんきょく いがいの せかいじゅう', en: 'Worldwide except Antarctica' },
  'すかんく': { regions: ['north_america', 'south_america'], ja: 'きたアメリカ・みなみアメリカ', en: 'North & South America' },
  'あるぱか': { regions: ['south_america'], ja: 'みなみアメリカの やま', en: 'Mountains of South America' },
  'かめれおん': { regions: ['africa'], ja: 'アフリカ・マダガスカル', en: 'Africa & Madagascar' },
  'あらいぐま': { regions: ['north_america'], ja: 'きたアメリカ（にほんにも いるよ）', en: 'North America (also in Japan)' },
  'もぐら': { regions: ['north_america', 'europe', 'asia'], ja: 'きたアメリカ・ヨーロッパ・アジア', en: 'North America, Europe & Asia' },
  'いたち': { regions: ['north_america', 'europe', 'asia'], ja: 'きたアメリカ・ヨーロッパ・アジア', en: 'North America, Europe & Asia' },
  'つる': { regions: ['north_america', 'europe', 'asia', 'africa', 'japan'], ja: 'アジア・ヨーロッパ・きたアメリカ・アフリカ', en: 'Asia, Europe, N. America & Africa' },
  'わし': { regions: ['worldwide'], ja: 'なんきょく いがいの せかいじゅう', en: 'Worldwide except Antarctica' },
  'かわせみ': { regions: ['worldwide'], ja: 'せかいじゅう', en: 'Worldwide' },
  'おうむ': { regions: ['oceania', 'asia'], ja: 'オーストラリア・アジア', en: 'Australia & Asia' },
